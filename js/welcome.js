    ...
    if (!getCookie("agreementAccepted")) {
        ...
        swal({
            ...
            content: {
                ...
                attributes: {
                    innerHTML: `
                        <img src='/images/avatar.webp' alt='fas fa-user' 
                        ...
                        5. <a href='/cookie/' title='cookie协议' data-pjax-state=''>Cookies</a>&nbsp;&nbsp;<br /><br />
